...
import type { IPatient } from "./interface";
...
const PatientTable = () => {
  ...
  const handlePatientAction = (patient: IPatient, action: string) => {
    switch (action) {
      case "view":
        navigate(`/patient/detail/${patient.id}`, { state: patient });
        break;
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                            <button
                              onClick={() =>
                                handlePatientAction(patient, "view")
                              }
                              className="p-2 text-slate-400 hover:text-teal-600 hover:bg-teal-50 rounded-lg transition-colors"
                            >
                              <BsPrinter className=""></BsPrinter>
                            </button>
                            <button
                              onClick={() =>
                                handlePatientAction(patient, "update")
                              }
