      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 text-center">
          ...
          <p className="text-slate-600 mb-6">
            The patient details could not be loaded. Please go back and try
            again.
          </p>
          <button
            onClick={() => navigate(-1)}
  ...
  return (
    <div className="max-w-6xl mx-auto my-10">
          ...
          <div className="flex items-start gap-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span
                  className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getGenderColor(
                    data.gender
                  )}`}
                >
                ...
                <span
                  className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getBloodGroupColor(
                    data.bloodGroup
                  )}`}
                >
                  {data.bloodGroup}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div
          className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 xl:col-span-1"
          style={{
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <span
                  className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border ${getBloodGroupColor(
                    data.bloodGroup
                  )}`}
                >
                  {data.bloodGroup}
              ...
              <div className="p-4 rounded-xl border border-slate-200 bg-white/50">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600">
                      {data.staffRegisteredBy.role || "Staff Member"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl border border-slate-200 bg-white/50">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600">
                      {data.adminRegisteredBy.role || "Administrator"}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-end mt-8">
        ...
        <button
          onClick={() =>
            navigate(`/episode/create`, { state: { patient: data } })
          }
          className="px-6 py-3 text-white rounded-xl transition-all duration-200 font-semibold shadow-sm hover:shadow-md"
          style={{
            background: "linear-gradient(135deg, #10b981 0%, #059669 100%)",
